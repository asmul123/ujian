                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body p-20">
                            <div class="btn-group">
                                <a href="<?= base_url('test')  ?>" class="btn btn-warning mb-20">
                                    <i class="fa fa-arrow-left text-white"></i>
                                    Kembali
                                </a>
                                <a href="<?= base_url('test/ubah_test/' . $idtest)  ?>" class="btn btn-info mb-20">
                            ...
                            <div class="btn-group" style="float: right;">
                                ...
                                <a href="<?= base_url('test/release_token/' . $idtest) ?>" class="btn btn-danger mb-20">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="min-width: 100px" class="text-center">
                                                <div class="btn-group">
                                                    <?php if ($status_test) { ?>
                                                        <a href="<?= base_url('test/reset_test_peserta/') . $idtest . '/' . $status_test->id ?>" class="btn btn-warning"><i class="fa fa-refresh"></i></a>
                                                        <a href="<?= base_url('test/hapus_test_peserta/') . $idtest . '/' . $status_test->id ?>" class="btn btn-danger" onclick="return confirm('Yakin untuk menghapus jawaban peserta?')"><i class="fa fa-trash"></i></a>
                                                        <a href="<?= base_url('test/selesai_test_peserta/') . $idtest . '/' . $status_test->id ?>" class="btn btn-success" onclick="return confirm('Yakin untuk menyelesaikan test ini?')"><i class="fa fa-check"></i></a>
                                                    <?php } ?>
                                                </div>
                                            </td>
                                        </tr>
