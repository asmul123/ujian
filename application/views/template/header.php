...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/Theme/css/switchery/switchery.min.css">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="navbar-header no-padding">
                        <a class="navbar-brand" href="<?php echo base_url() ?>">UJIAN - SMKN 1 GARUT
                        </a>
                        ...
                        <ul class="nav navbar-nav navbar-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            <li class="dropdown tour-two">
                                ...
                                <ul class="dropdown-menu profile-dropdown">
                                    ...
                                    <li><a href="<?php echo site_url('clogin/logout'); ?>" class="color-danger text-center"><i class="fa fa-sign-out"></i> Keluar</a></li>
                                </ul>
                            </li>
                        </ul>
