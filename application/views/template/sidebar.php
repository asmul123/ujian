                ...
                <div class="sidebar-nav">
                    <ul class="side-nav color-gray">
                        ...
                        <?php foreach ($menu as $menu) {
                            $a = $menu->id_menu ?>
                            <li class="has-children <?php if ($activeMenu === $menu->id_menu) {
                                                        echo 'open';
                                                    } ?>">
                                ...
                                <ul class="child-nav">
                                    ...
                                    foreach ($submenus->result() as $submenu) { ?>
                                        <li><a href="<?php echo site_url($submenu->linksubmenu); ?>"><i class="fa fa-edit"></i><span> <?php echo $submenu->submenu; ?></span></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
